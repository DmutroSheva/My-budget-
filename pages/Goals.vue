<template>
  <div class="goals">
    ...
    <p>
      <strong>Отложено всего:</strong>
      {{ totalAllocatedAmount }} UA
    </p>
    <!-- Общий баланс отложенных денег -->
    <form
      @submit.prevent="addNewGoalHandler"
      class="goal-form"
    >
      <select
    ...
    <ul>
      ...
      >
        ...
        ({{ goal.title }}): {{ goal.amount }} UA
        <br />
        <strong>Вы отлажили:</strong>
        {{ goal.allocatedAmount }} из {{ goal.amount }} UA
        <button
